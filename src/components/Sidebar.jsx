    ...
    return (
        <>
            <div className='flex h-screen'>
                ...
                <div className={`h-full ${isOpen ? "w-2/3" : "w-[16%] md:w-[7%] lg:w-[4%]"} duration-300 fixed z-10 md:w-2/5 lg:w-1/5 flex flex-col bg-white border-r shadow-sm`}>
                    ...
                    <div className="flex flex-col h-full justify-between">
                        <div className="flex flex-col">
                            <div onClick={() => {
                                Navigate('/Dashboard')
                            }} className={`flex mx-3 my-1 p-1 w-[90%] rounded-md text-gray-600 group hover:text-black hover:font-bold hover:bg-gray-100 hover:cursor-pointer ${!isOpen && "w-[52%] lg:w-[50%] my-2"}`}>
                ...
                <div className="w-full p-8 ml-10">
                    <Outlet />
                </div>
            </div>
        </>
